...
* Создать проект [GitBook](https://www.gitbook.com) и настроить синхронизацию с [GitHub](https://github.com)
* Выгрузить исходники проекта с [GitHub](https://github.com) в виде архива и распаковать в папку /help-main/
* Настроить синхронизацию данных с [GitHub](https://github.com) с помощью update-sample.sh (требуется указать свои данные)
...
## Плюсы
* Нет блокировки ресурсов gitbook.io в мобильном трафике.
* Использование своего доменного имени на бесплатном тарифе GitBook Free
* Работает на любом тарифе популярных хостингов без установки стороннего ПО.
* На порядок быстрее загружается и отображается содержимое.
* Оптимизация для SEO.
* Простой файл шаблона на Bootstrap.
* Возможность подключения Яндекс.Метрики и других виджетов статистики или чатов.

## Минусы
* Редактирование контента на стороне GitBook
