...
class Parsedown
{
    ...
    {
        //Fix РїСЂРѕР±РµР»С‹ РІ РёРјРµРЅР°С…
        if(strstr($Excerpt['text'],'<')){
            $Excerpt['text']=str_replace(['<','>'],['',''],$Excerpt['text']);
            $Excerpt['context']=$Excerpt['text'];
        }
...
function toLatin($str, $lower = true) {
